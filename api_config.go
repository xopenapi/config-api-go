...
func (a *ConfigApiService) Create(ctx _context.Context, body CreateConfigReq) (ApiResponseConfig, *_nethttp.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/config/create"
...
@return ConfigApiResponse
*/
func (a *ConfigApiService) Update(ctx _context.Context, body UpdateConfigReq) (ConfigApiResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/config/update"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
